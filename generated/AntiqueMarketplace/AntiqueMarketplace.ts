...
export class AntiqueMarketplace__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class AntiqueMarketplace extends ethereum.SmartContract {
  static bind(address: Address): AntiqueMarketplace {
    return new AntiqueMarketplace("AntiqueMarketplace", address);
  }

  getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): AntiqueMarketplace__getListingResultValue0Struct {
    ...
    return changetype<AntiqueMarketplace__getListingResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<AntiqueMarketplace__getListingResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<AntiqueMarketplace__getListingResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
...
export class UpdatedListingCall extends ethereum.Call {
  get inputs(): UpdatedListingCall__Inputs {
    return new UpdatedListingCall__Inputs(this);
  }

  get outputs(): UpdatedListingCall__Outputs {
    return new UpdatedListingCall__Outputs(this);
  }
}

export class UpdatedListingCall__Inputs {
  _call: UpdatedListingCall;

  constructor(call: UpdatedListingCall) {
    this._call = call;
  }
...
export class UpdatedListingCall__Outputs {
  _call: UpdatedListingCall;
